...
NS: Need "compute_k_buoyancy_balance_16T.py" to run before to create "file_buoyb"
    Need "extract_tracer_bbl.py" to run before to create "rrexnumsb200-rsup5_16T_porcentage_in_BBL.nc"
    ...
    This code is for the TRE_ref simulations
'''
...
if plot_buoy_balance==True:
	...
	plt.savefig('figure11.png',dpi=200,bbox_inches='tight')
