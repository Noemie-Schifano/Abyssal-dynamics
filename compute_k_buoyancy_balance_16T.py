...
NS: Compute and save diagnostics for each TRE
    nota bene: The same 16 TREs are released but with 6 hours-intervals, in this code it is the 
                 referenced 16 TREs that are analysed    
'''
...
if test_nc == True :
    ndfiles     = 2
    time        = np.arange(0,1)
    file_diag_k = '/home/datawork-lops-rrex/nschifan/DIAGS/test_rrexnumsb200-rsup5_16tracers_k_buoy_balance.nc'
else:
    ndfiles     = 24
    time        = np.arange(0,25,24)
    if sigma2 == True:
        file_diag_k = '/home/datawork-lops-rrex/nschifan/DIAGS/rrexnumsb200-rsup5_16tracers_k_buoy_sigma2_balance.nc'
    elif rhop_tracer == True:
        file_diag_k = '/home/datawork-lops-rrex/nschifan/DIAGS/rrexnumsb200-rsup5_16tracers_k_buoy_rhop_tracer_balance.nc'
    else:
        file_diag_k = '/home/datawork-lops-rrex/nschifan/DIAGS/rrexnumsb200-rsup5_16tracers_k_buoy_balance.nc'
